...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Rifa`i", "Audrey", "Vahloon", "Alsani", "Dimas", "Angelita", "Reza"],
      ["Aulia", "Altha", "Raehan", "Fitria", "Keenan", "Desvita"],
      ["Irma", "Zaki", "Nafasat", "Hafiz", "Jelita", "Marsya", "Maylyana"],
      ["Maita", "Raka", "Orieviano", "Natasya", "Naura", "Rasya"],
      ["Renata", "Rio", "Sherin", "Dicky", "Sellina", "Gilang"],
    ];
